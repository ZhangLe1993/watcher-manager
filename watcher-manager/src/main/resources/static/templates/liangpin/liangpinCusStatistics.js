 ...
 */
Template.liangpinCusStatistics.rendered = function () {
    $('.navi-tab').removeClass('active');
    $('#liangpin').addClass('active');
    $('#liangpinCusStatistics').addClass('active');
    ...
    //选项初始化加载
    requestURL(dataService+"/lianpin/getLiangpinCusStatisticsTrafficFilterOptions",{}).done(function(data){
        /*网址*/
        $(".web").attr("multiple","multiple");
        renderOptions(".web",["爱二手 - mobile","爱二手-pc"]);
...
function getValue(){
    ...
    if(flag=="daily"){
        ...
        query=cleanParams(query);
            requestURL(dataService + "/lianpin/getLiangpinCusStatisticsDay", query).done(function (data) {
                exportData=data;
...
//                drawoldCusStaChart(data,flag,site);
        ...
        query=cleanParams(query);
            requestURL(dataService + "/lianpin/getLiangpinCusStatisticsWeek", query).done(function (data) {
                exportData=data;
                drawcusStaChart(data,flag,site);
//                drawnewCusStaChart(data,flag,site);
//                drawoldCusStaChart(data,flag,site);
        ...
        query=cleanParams(query);
             requestURL(dataService + "/lianpin/getLiangpinCusStatisticsMonth", query).done(function (data) {
                 exportData=data;
                 drawcusStaChart(data,flag,site);
    //                drawnewCusStaChart(data,flag,site);
    //                drawoldCusStaChart(data,flag,site);
