Template.tradeMethodReport.rendered = function () {
    ...
    requestURL(dataService + "/tradeCountDetail/tradeMethod",query).done(function (data) {
        drawTradeMethodReport(data,flag);
    });
...
function drawTradeMethodReport(tradeNumDataSet,flag) {
    ...
    var tradeMethodReportChart = echarts.init(document.getElementById('tradeMethodReport'));
    tradeMethodReportChart.setOption(option)
    window.addEventListener('resize',tradeMethodReportChart.resize);
}
