Template.sourceTypeMoneyReport.rendered = function () {
...
function drawSourceTypeLineReport(tradeNumDataSet,flag) {
    ...
    /*if (startDate == undefined) {
     ...
     var tradeNumDataSet = sourceTypeTradeReport.find({$and: [{date: {$gte: startDate}}, {date: {$lte: endDate}}]}, {sort: {date: 1}}).fetch();*/
    ...
    var sourceTypeTradeReportChart = echarts.init(document.getElementById('sourceTypeMoneyReport'));
