 ...
 */
Template.VenderIncomeAnalysis.rendered = function () {
    $('.navi-tab').removeClass('active');
    $('#VenderTab').addClass('active');
    $('#VenderIncomeAnalysis').addClass('active');
...
function renderPage(filter){
    ...
    promise.done(function(ret){
        ...
        renderTable("#IncomeAnalysisTable",ret);
...
function getAggregateWebTrafficData(filter){
    ...
    var dfd = $.Deferred();
    requestURL(dataService+"/Vender/getAgentIncomeAnalysis",query).done(function(ret){
        dfd.resolve(ret)
    });
    return dfd.promise()
}
