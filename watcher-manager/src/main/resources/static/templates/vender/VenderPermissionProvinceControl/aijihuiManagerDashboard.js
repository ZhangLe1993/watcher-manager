...
Template.aijihuiManagerDashboard.rendered = function () {
    ...
    requestURL(dataService + "/Vender/getVenderPermissionControlToGroupIdJsonInfo", {"type":"venderGroup", userId: userId}).done(function(data){
    ...
    $(".type").on('change',function(){
        requestURL(dataService + "/Vender/getVenderPermissionControlToGroupIdJsonInfo", {"type":($(".type").val()=="")?"venderGroup":$(".type").val(), userId: userId}).done(function(data){
            groupIdInfo=data.venderGroupId;
            updateDashboard();
    ...
    function getVenderAccumulateTrendOrder(){
        requestURL(dataService + "/Vender/getVenderAccumulateTrendOrderByUserId", {"type":($(".type").val()=="")?"venderGroup":$(".type").val(), userId: userId}).done(function(data){
    ...
    function getYesterdayCurrentTimeData(isFirst){
        ...
        requestURL(dataService + "/Vender/getVenderYesterdayCurrentTimeStatsByUserId", {"type":($(".type").val()=="")?"venderGroup":$(".type").val(), userId: userId}).done(function (ret) {
