...
Template.marketingTrafficMonitor.rendered = function () {
    $('.navi-tab').removeClass('active');
    $('#MarketingTab').addClass('active');
    $('#marketingTraffic').addClass('active');
    ...
    var startDate = '2017-07-25';
    var startWeekDate = '2017-07-23';
    var endWeekDate = '2017-07-29';
    if(startWeekDate<minWeekDate){
        startWeekDate = minWeekDate;
    }
    var startMonthDate = '2017-07-01';
    var endMonthDate = '2017-07-31';
...
function getUVChartsData(filter){
    ...
    //    renderUVCharts(data);
    //})
    requestURLPost(dataService+"/webTraffic/getMarketingAggregateTraffic",query).done(function(ret){
        renderUVCharts(ret)
    });
}
                ...
                case 'SEM':
                    switch (datatype) {
                        ...
                        case 'submit_inquiry_rate':
                            uv.SEM.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            SEMSeries.uv.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            SEMSeries.date.push(e.date);
                            Queried[1]=1;
                            break;
                        case 'submit_uv_rate':
                ...
                case '其他渠道':
                    switch (datatype) {
                        ...
                        case 'inquiry_uv_rate':
                            ...
                            break;
                        case 'submit_inquiry_rate':
                            uv.其他渠道.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            OtherChannelSeries.uv.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            OtherChannelSeries.date.push(e.date);
                            Queried[2]=1;
                            break;
                        case 'submit_uv_rate':
                ...
                case '新流量渠道':
                    switch (datatype) {
                        ...
                        case 'inquiry_uv_rate':
                            ...
                            break;
                        case 'submit_inquiry_rate':
                            uv.新流量渠道.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            NewChannelSeries.uv.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            NewChannelSeries.date.push(e.date);
                            Queried[3]=1;
                            break;
                        case 'submit_uv_rate':
                ...
                case '微信公众号':
                    switch (datatype) {
                        ...
                        case 'inquiry_uv_rate':
                            ...
                            break;
                        case 'submit_inquiry_rate':
                            uv.微信公众号.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            WechatSeries.uv.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            WechatSeries.date.push(e.date);
                            Queried[4]=1;
                            break;
                        case 'submit_uv_rate':
                ...
                case '直接访问':
                    switch (datatype) {
                        ...
                        case 'inquiry_uv_rate':
                            ...
                            break;
                        case 'submit_inquiry_rate':
                            uv.直接访问.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            DirectSeries.uv.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            DirectSeries.date.push(e.date);
                            Queried[5]=1;
                            break;
                        case 'submit_uv_rate':
                ...
                case 'APP':
                    switch (datatype) {
                        ...
                        case 'inquiry_uv_rate':
                            ...
                            break;
                        case 'submit_inquiry_rate':
                            uv.APP.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            APPSeries.uv.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            APPSeries.date.push(e.date);
                            Queried[6]=1;
                            break;
                        case 'submit_uv_rate':
                ...
                case 'SEO':
                    switch (datatype) {
                        ...
                        case 'inquiry_uv_rate':
                            ...
                            break;
                        case 'submit_inquiry_rate':
                            uv.SEO.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            SEOSeries.uv.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            SEOSeries.date.push(e.date);
                            Queried[7]=1;
                            break;
                        case 'submit_uv_rate':
                ...
                case '市场活动':
                    switch (datatype) {
                        ...
                        case 'inquiry_uv_rate':
                            ...
                            break;
                        case 'submit_inquiry_rate':
                            uv.市场活动.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            MarketingSeries.uv.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            MarketingSeries.date.push(e.date);
                            Queried[8]=1;
                            break;
                        case 'submit_uv_rate':
                ...
                case '合作渠道':
                    switch (datatype) {
                        ...
                        case 'inquiry_uv_rate':
                            ...
                            break;
                        case 'submit_inquiry_rate':
                            uv.合作渠道.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            CooperateSeries.uv.push(e.inquiry_uv==0?0:((e.submit_success_uv/ e.inquiry_uv)*100).toFixed(2));
                            CooperateSeries.date.push(e.date);
                            Queried[9]=1;
                            break;
                        case 'submit_uv_rate':
...
function getSelectedFilter(dateType,Mobile){
    ...
    var filter = {};
    if(Mobile==false) {
        var channel = $(document).find(".channel").val();
        var cityName = $(document).find(".city").val();

        var platform = $(document).find(".platform").val();
        var areaName = $(document).find(".areaName").val();
        var source=getAutocompleteMultipleSelectedFilter($(document).find(".source").val());
        var medium=getAutocompleteMultipleSelectedFilter($(document).find(".medium").val());
        var campaign=getAutocompleteMultipleSelectedFilter($(document).find(".campaign").val());
        ...
        var channelM = $(document).find(".mobile-only .channel").val();
        var cityNameM = $(document).find(".mobile-only .city").val();
        var platformM = $(document).find(".mobile-only .platform").val();
        var areaNameM = $(document).find(".mobile-only .areaName").val();
        var sourceM=getAutocompleteMultipleSelectedFilter($(document).find(".mobile-only .source").val())
        var mediumM=getAutocompleteMultipleSelectedFilter($(document).find(".mobile-only .medium").val())
        var campaignM=getAutocompleteMultipleSelectedFilter($(document).find(".mobile-only .campaign").val())
        filter = {
            "dateType": dateType,
            "startDate": startDate,
            "endDate": endDate,
...
function renderTable(filter,objAll){
    ...
    $("#cdataExport").click(function(){
        ...
        if(flag=="daily" || !flag){
            requestURLPost(dataService+"/webTraffic/exportDailyMarketingWebTrafficData",query).done(function(obj){
                $("#wholePage").unmask();
            ...
            requestURLPost(dataService+"/webTraffic/exportWeeklyMarketingWebTrafficData",query).done(function(obj){
                $("#wholePage").unmask();
                var url = Meteor.settings.public.downloadService.baseUrl+obj.fileName;
                var link = document.createElement("a");
                link.href = url;
            ...
            requestURLPost(dataService+"/webTraffic/exportMonthlyMarketingWebTrafficData",query).done(function(obj){
                $("#wholePage").unmask();
                var url = Meteor.settings.public.downloadService.baseUrl+obj.fileName;
                var link = document.createElement("a");
                link.href = url;
...
function getFilterOptions(){
    var dfd = $.Deferred();
    requestURL(dataService+"/webTraffic/getMarketingFilterOptions",{}).done(function(ret){
        dfd.resolve(ret)
    });
    return dfd.promise()
}
...
function  getMarketingWebTraffic(filter){
    ...
    var dfd = $.Deferred();
    if(flag=="daily" || !flag){
        requestURLPost(dataService+"/webTraffic/getDailyMarketingWebTrafficData",query).done(function(ret){
            dfd.resolve(ret)
        });

    }else if(flag=="weekly"){
        requestURLPost(dataService+"/webTraffic/getWeeklyMarketingWebTrafficData",query).done(function(ret){
            dfd.resolve(ret)
        });
    }else if(flag=="monthly"){
        requestURLPost(dataService+"/webTraffic/getMonthlyMarketingWebTrafficData",query).done(function(ret){
            dfd.resolve(ret)
        });
    }
    return dfd.promise()
...
function getAggregateWebTrafficData(filter){
    ...
    if(flag=="daily" || !flag){
        ...
        requestURLPost(dataService+"/webTraffic/getWeeklyAggregateMarketingWebTrafficData",query).done(function(ret){
            dfd.resolve(ret)
        });
    }else if(flag=="monthly"){
        requestURLPost(dataService+"/webTraffic/getMonthlyAggregateMarketingWebTrafficData",query).done(function(ret){
            dfd.resolve(ret)
        });
    }
    return dfd.promise()
...
function getCalcData(data){
    ...
    return {"trade_tranfers_rate":trade_tranfers_rate,"per_amount_num":per_amount_num,"trade_uv_rate":trade_uv_rate,"trade_success_uv_rate":trade_success_uv_rate,"total_rate":total_rate,"inquiry_uv_rate":inquiry_uv_date,"uv":uv,"inquiry_uv":inquiry_uv,"trade_uv":trade_uv,"trade_success_uv":trade_success_uv,"trade_cnt_num":trade_cnt_num,"trade_success_cnt_num":trade_success_cnt_num,"trade_success_amount_num":trade_success_amount_num}
}
//根据日期获取总的数据
