Template.XHJLogMonitor.rendered = function () {
    $('.navi-tab').removeClass('active');
    $('#ITTab').addClass('active');
    $('#XHJMonitorTab').addClass('active');
    ...
    var updateHostStatusChart = function () {
        ...
        requestURL(dataService + "/logMonitor/XHJ/hostStatusStats", query).done(function (data) {
    ...
    var updateHostPageTimeChart = function () {
        ...
        requestURL(dataService + "/logMonitor/XHJ/hostPageTimeStats", query).done(function (data) {
    ...
    var updateHostPageTimeAvgChart = function () {
        ...
        requestURL(dataService + "/logMonitor/XHJ/getHostPageResTimeAvg", query).done(function (data) {
