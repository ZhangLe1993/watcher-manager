/**
 * Created by liufangliang on 2017-03-27.
 */
Template.JDTradeMonitorJDOnly.rendered = function () {

    $('.navi-tab').removeClass('active');
    $('#JDDataserviceTab').addClass('active');
    $('#JDTradeMonitorJDOnly').addClass('active');
...
function agentSourceToPlatform(dataSet) {
    ...
    // AggregatedData.forEach(function (e) {
    //     var cnt = 0;
    //     var platform = parseAgentSource(e.jdPlatform);
    //     while(platform != parseAgentSource(dataSet[cnt].jdPlatform) && cnt<100){
    //         cnt ++
    //     }
    //     if(platform == parseAgentSource(dataSet[cnt].jdPlatform)){
    //         data.createdDt=e.createdDt
    //
    //     }
    // })
}
