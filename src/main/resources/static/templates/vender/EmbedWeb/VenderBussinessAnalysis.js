 ...
 */
Template.VenderBussinessAnalysis.rendered = function () {
    $('.navi-tab').removeClass('active');
    $('#VenderTab').addClass('active');
    $('#VenderBussinessAnalysis').addClass('active');
...
//    var flag = query["dateType"];
    ...
    var dfd = $.Deferred();
    requestURL(dataService+"/Vender/getAgentBussinessAnalysis",query).done(function(ret){
        dfd.resolve(ret)
    });
    return dfd.promise()
}
