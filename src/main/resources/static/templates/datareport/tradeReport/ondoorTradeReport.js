...
function drawOndoorTradeReport(tradeNumDataSet) {
    ...
    var ondoorDealReportChart = echarts.init(document.getElementById('ondoorDealReport'));
    ondoorDealReportChart.setOption(option)
    window.addEventListener('resize',ondoorDealReportChart.resize);
}
